...
{
    /// <summary>
    /// A simple distributed lock based on a MongoDB document with a defined TTL. The presence of the document
    ...
    /// </summary>
    public sealed class MongoDbDistributedLock : IMongoDbDistributedLock
    {
        ...
        public MongoDbDistributedLock(Func<IScoped<IDocumentClient>> documentClientFactory, Uri collectionUri, string lockId, ILogger<MongoDbDistributedLock> logger)
        ...
        public MongoDbDistributedLock(Func<IScoped<IDocumentClient>> documentClientFactory, Uri collectionUri, string lockId, ILogger<MongoDbDistributedLock> logger, TimeSpan lockDocumentTimeToLive)
        {
