...
{
    /// <summary>
    /// Logger used for logging <see cref="MongoDocumentQuery{T}"/>.
    /// </summary>
    public class MongoDocumentQueryLogger : IMongoDocumentQueryLogger
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MongoDocumentQueryLogger"/> class.
        /// </summary>
        /// <param name="logger">The logger.</param>
        public MongoDocumentQueryLogger(
