...
namespace Microsoft.Health.Fhir.MongoDb.Features.Storage.Versioning
{
    public class CollectionUpgradeManager : IUpgradeManager
    {
        ...
        private readonly MongoDataStoreConfiguration _configuration;
        ...
        private readonly IMongoDbDistributedLockFactory _lockFactory;
        ...
        public CollectionUpgradeManager(
            ...
            MongoDataStoreConfiguration configuration,
            IMongoDbDistributedLockFactory lockFactory,
