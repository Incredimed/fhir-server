...
using Microsoft.Health.Fhir.MongoDb.Features.Storage.Search;
using Newtonsoft.Json;

namespace Microsoft.Health.Fhir.MongoDb.Features.Storage
{
    internal class MongoResourceWrapper : ResourceWrapper
    {
        public MongoResourceWrapper(ResourceWrapper resource)
            : this(
        ...
        [JsonConstructor]
        protected MongoResourceWrapper()
        {
        }
