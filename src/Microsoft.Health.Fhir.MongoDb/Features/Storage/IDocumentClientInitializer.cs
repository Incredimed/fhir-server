...
namespace Microsoft.Health.Fhir.MongoDb.Features.Storage
{
    ...
    {
        /// <summary>
        /// Creates am unopened <see cref="IDocumentClient"/> based on the given <see cref="MongoDataStoreConfiguration"/>.
        /// </summary>
        /// <param name="configuration">The endpoint and collection settings</param>
        /// <returns>A <see cref="IDocumentClient"/> instance</returns>
        IDocumentClient CreateDocumentClient(MongoDataStoreConfiguration configuration);
        ...
        Task OpenDocumentClient(IDocumentClient client, MongoDataStoreConfiguration configuration);
        ...
        Task InitializeDataStore(IDocumentClient documentClient, MongoDataStoreConfiguration mongoDataStoreConfiguration);
    }
}
