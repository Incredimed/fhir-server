...
namespace Microsoft.Health.Fhir.MongoDb.Features.Storage.Search
{
    internal class SearchIndexEntryJObjectGenerator : ISearchValueVisitor
    {
        ...
        void ISearchValueVisitor.Visit(DateTimeSearchValue dateTime)
        {
            ...
            // formatted as 2018-01-01T00:00:00.9999999+00:00. Because MongoDB only supports range index
