...
namespace Microsoft.Health.Fhir.MongoDb.Features.Storage.Continuation
{
    /// <summary>
    /// Defines a contract for caching and retrieving MongoDB continuation tokens
    /// </summary>
    /// <remarks>
    /// The larger a MongoDB collection grows, the bigger the Continuation Token gets.
    ...
    public interface IContinuationTokenCache
    {
        ...
        /// <returns>The Continuation Token for MongoDB</returns>
        ...
        /// </summary>
        /// <param name="continuationToken">The Continuation Token from MongoDB</param>
        /// <param name="cancellationToken">Cancellation token</param>
