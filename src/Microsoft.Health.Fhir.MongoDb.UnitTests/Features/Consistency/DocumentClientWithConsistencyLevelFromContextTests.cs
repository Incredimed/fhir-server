...
namespace Microsoft.Health.Fhir.MongoDb.UnitTests.Features.Consistency
{
    public class DocumentClientWithConsistencyLevelFromContextTests
    {
        ...
        public async Task GivenACreateRequest_WithSessionConsistency_ThenTheResponseHeadersContainTheSessionToken()
        {
            _innerClient
                ...
                .Returns(CreateResourceResponse(new Document(), HttpStatusCode.OK, new NameValueCollection { { MongoDbConsistencyHeaders.SessionToken, "2" } }));

            _requestHeaders.Add(MongoDbConsistencyHeaders.ConsistencyLevel, "Session");
            _requestHeaders.Add(MongoDbConsistencyHeaders.SessionToken, "1");

            await _consistentClient.CreateDocumentAsync("coll", (1, 2));

            Assert.True(_responseHeaders.TryGetValue(MongoDbConsistencyHeaders.SessionToken, out var values));
        ...
        public async Task GivenAFeedRequest_WithSessionConsistency_ThenTheResponseHeadersContainTheSessionToken()
        {
            _innerClient
                ...
                .Returns(CreateFeedResponse(Enumerable.Empty<Database>(), new NameValueCollection { { MongoDbConsistencyHeaders.SessionToken, "2" } }));
        ...
        {
            _requestHeaders.Add(MongoDbConsistencyHeaders.ConsistencyLevel, "CatsAndDogs");
        ...
        public async Task GivenAStoredProcedureRequestWithLink_WithSessionConsistency_ThenTheResponseHeadersContainTheSessionToken()
        {
            _innerClient
                ...
                .Returns(CreateStoredProcedureResponse(42, HttpStatusCode.OK, new NameValueCollection { { MongoDbConsistencyHeaders.SessionToken, "2" } }));
        ...
        public async Task GivenAFeedRequest_WithAStrongerConsistencyLevelThanTheDefault_ThenABadRequestExceptionIsThrown(ConsistencyLevel defaultConsistencyLevel, ConsistencyLevel requestedConsistencyLevel)
        {
            ...
            _requestHeaders.Add(MongoDbConsistencyHeaders.ConsistencyLevel, requestedConsistencyLevel.ToString());
